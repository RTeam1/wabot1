...
coli = body.slice(6)
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/harta_tahta?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
...
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/avenger?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}`, {method: 'get'})
...
if (args.length < 1) return reply('Teks nya mana?')
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/battlefield?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}`, {method: 'get'})
...
coli = body.slice(6)
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/blackpink?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
...
coli = body.slice(6)
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/blood?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
...
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/bokeh?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'nieh udah jadi kak!'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
...
coli = body.slice(6)
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/csgo?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
...
if (args.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/crossfire?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
...
if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
reply(ind.wait())
buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/einstein?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
...
if (args.length < 1) return reply('Teks nya mana kak?')
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/fb_silver_play_button?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/fb_golden_play_button?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/fire?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/firework?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
	var gh = body.slice(9)
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/football?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/gta_original?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/gta_wasted?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/glitch?apikey=TUK4N6.741L&text1=${text1}&text2=${text2}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/glow?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/google_suggestion?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}&text3=${coli3}`, {method: 'get'})
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/harrypotter?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/hartatahta_custom?apikey=TUK4N6.741L&text1=${coli1}&text2=${coli2}&text3=${coli3}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/lovegif?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/marvel?apikey=TUK4N6.741L&text1=${text1}&text2=${text2}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/matrix?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/naruto?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/neon?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/pubg?apikey=TUK4N6.741L&text1=${text1}&text2=${text2}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/pentakill?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/pigtext?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/pornhub?apikey=TUK4N6.741L&text1=${text1}&text2=${text2}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/quoteslife?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break*/
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/rainbow?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/sandwriting?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/spiderman?apikey=TUK4N6.741L&text1=${text1}&text2=${text2}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/starwars?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/thunder?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/warface_avatar?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/warface?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nieh udah jadi kak!'})
await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
...
/*case 'pokemon':
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/randompussy?apikey=TUK4N6.741L`, {method: 'get'})
			...
			if (!isRegistered) return reply(ind.noregis())
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/hentaigif?apikey=TUK4N6.741L`, {method: 'get'})
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/randomhentai?apikey=TUK4N6.741L`, {method: 'get'})
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/randomnsfw?apikey=TUK4N6.741L`, {method: 'get'})
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/randomneko?apikey=TUK4N6.741L`, {method: 'get'})
		...
		if (!isRegistered) return reply(ind.noregis())
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/quotesnime?apikey=TUK4N6.741L`, {method: 'get'})
		...
		if (!isRegistered) return reply(ind.noregis())
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   if (!isNsfw) return reply(ind.nsfwoff())
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/anime/randomwaifu?apikey=TUK4N6.741L`, {method: 'get'})
					...
					reply(ind.wait())
					URL = body.slice(3)
					buffwer = await getBuffer(`https://naufalhoster.xyz/dl/youtube?apikey=TUK4N6.741L&url=${URL}`, {method: 'get'})
	...
	//				case 'yutub':
		 //		if (args.length < 1) return reply('Ling nya mana?')
			//		URL = body.slice(3)
//					reply(ind.wait())
  //   buffer = await getBuffer(`https://naufalhoster.xyz/dl/youtube?apikey=TUK4N6.741L&url=${URL}`, (method: 'get'})
...
///					0ig https://www.instagram.com/p/CDmEhuzs8_2/?igshid=157yai8f0vant
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/tools/sms?apikey=TUK4N6.741L&nomor=${text1}&pesan=${text2}`, {method: 'get'})
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/tools/nulis?apikey=TUK4N6.741L&nomor=${text1}&pesan=${text2}`, {method: 'get'})
					client.sendMessage(from, buffer, text, {quoted: mek})
					break
				//	https://naufalhoster.xyz/tools/sms?apikey=YOUR_API_KEY&nomor=089515746253&pesan=Order+bang
					...
					if (coli.length > 15) return reply('Teksnya kepanjangan, maksimal 15 karakter')
					reply(ind.wait())
					buffer = await getBuffer(`https://naufalhoster.xyz/textmaker/dewabatch?apikey=TUK4N6.741L&text=${coli}`, {method: 'get'})
					await costum(`btw pulsa nya belum masuk kak, limit juga berkurang 1 ya sayang`, text, tescuk, cr)
await limitAdd(sender)
					break
	//				case 'yutub':
